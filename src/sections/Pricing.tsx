      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-description mt-5">
            Free forever. Upgrade for unlmited tasks, better security and exclusive features.
          </p>
        </div>       
            ...
            ({
              ...
              <div className={twMerge("card", inverse === true && 'border-black bg-black text-white')}>
                <div className="flex justify-between">
                  <h3 className={twMerge("text-lg font-bold text-blck/50", inverse === true && 'text-white/60')}>{title}</h3>
                  {popular && (
                ...
                <div className="flex items-baseline gap-1 mt-[30px]">
                  <span className="text-4xl font-bol tracking-tighter leading-none">{monthlyPrice}</span>
